...
define([
  'marionette',
  'handlebars',
  'text!templates/boutonMenuPrincipal.html',
  'quintus-all'
],
function(Marionette, Handlebars, boutonMenuPrincipal) {
  return Marionette.ItemView.extend({
    ui: {
      boutonJouer: "#play"
    },
    events: {
      'click @ui.boutonJouer': 'jouer'
    },
    template: Handlebars.compile(boutonMenuPrincipal),
    jouer: function(){
      ...
      Q.Sprite.extend("Player",{
        ...
        init: function(p) {
          ...
          this._super(p, {
            ...
            x: 380,           // You can also set additional properties that can
          ...
          this.on("hit.sprite",function(collision) {
            ...
            if(collision.obj.isA("Tower")) {
              ...
              Q.stageScene("nextLevel",1, {
                label: "You Won!",
                numLevel: this.stage.scene.name.substring(5, this.stage.scene.name.length)
              });
          ...
          this.on("hit.collision", function(collision){
            if(collision.obj.collisionNormal.tile == 2){
              Q.stageScene("endGame",this.stage.scene.name.substring(5, this.stage.scene.name.length), { label: "You Died" });
              this.destroy();
            }
          ...
          Q.scene('endGame',function(stage) {
            ...
            Q.scene('nextLevel',function(stage) {
              ...
              var label = container.insert(new Q.UI.Text({x:10, y: -10 - button.p.h,
                ...
                button.on("click",function() {
                  Q.clearStages();
                  Q.stageScene("level" + (parseInt(stage.options.numLevel) + 1));
                });
